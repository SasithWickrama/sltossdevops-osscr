        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="http://ossportal/osscr/?a=projectList">CR
                            LIST</a>
                    </li>
                    <li class="nav-item">
    ...
    <main role="main" class="container">
        ...
        <div class="col-md-12 col-lg-12">
            <h4 class="mb-3"><?php if ($crdetails) {
                                    ...
                                    echo "<script type='text/javascript'>alert('Invalid CR Number'); window.location.href = \"http://ossportal/osscr/?a=projectList\";</script>";
                                } ?> </h4>
            <br />
            ...
            <div class="row g-3">
                ...
                <div class="row" style="padding-top: 30px;">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <td colspan="5"><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" disabled <?php if ($crcat) {
                                                                                                                                            if ($crcat[0]['CONFIG'] == 1) {
                                                                                                                                                echo 'checked';
                                                                                                                                            }
                                                                                                                                        } ?>>
                                ...
                                <td colspan="3"><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" disabled <?php if ($crcat) {
                                ...
                                <td colspan="2"><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" disabled <?php if ($crcat) {
                        ...
                        <tbody>
                            <tr>
                                <td> <input class="form-check-input" type="checkbox" value="" id="bsscheck" <?php if ($crcat) {
                                                                                                                if ($crcat[0]['BSS'] == 1) {
                                                                                                                    echo 'checked';
                                                                                                                }
                                                                                                            } ?>>
                                ...
                                <td><input class="form-check-input" type="checkbox" value="" id="osscheck" <?php if ($crcat) {
                                                                                                                if ($crcat[0]['OSS'] == 1) {
                                                                                                                    echo 'checked';
                                                                                                                }
                                                                                                            } ?>>
                                ...
                                <td><input class="form-check-input" type="checkbox" value="" id="crmcheck" <?php if ($crcat) {
                                                                                                                if ($crcat[0]['CRM'] == 1) {
                                                                                                                    echo 'checked';
                                                                                                                }
                                                                                                            } ?>>
                                ...
                                <td><input class="form-check-input" type="checkbox" value="" id="mdmcheck" <?php if ($crcat) {
                                                                                                                if ($crcat[0]['MDM'] == 1) {
                                                                                                                    echo 'checked';
                                                                                                                }
                                                                                                            } ?>>
                                ...
                                <td><input class="form-check-input" type="checkbox" value="" id="preuatcheck" <?php if ($crcat) {
                                ...
                                <td><input class="form-check-input" type="checkbox" value="" id="pmuatcheck" <?php if ($crcat) {
                                                                                                                    if ($crcat[0]['PM_UAT'] == 1) {
                                                                                                                        echo 'checked';
                                                                                                                    }
                                                                                                                } ?>>
                                ...
                                <td><input class="form-check-input" type="checkbox" value="" id="uatcheck" <?php if ($crcat) {
                                                                                                                if ($crcat[0]['UAT'] == 1) {
                                                                                                                    echo 'checked';
                                                                                                                }
                                                                                                            } ?>>
                                ...
                                <td><input class="form-check-input" type="checkbox" value="" id="prodcheck" <?php if ($crcat) {
                                ...
                                <td><input class="form-check-input" type="checkbox" value="" id="pmcheck" <?php if ($crcat) {
                                                                                                                if ($crcat[0]['PM'] == 1) {
                                                                                                                    echo 'checked';
                                                                                                                }
                                                                                                            } ?>>
                                ...
                                <td><input class="form-check-input" type="checkbox" value="" id="depcheck" <?php if ($crcat) {
                ...
                <div class="row" style="padding-top: 30px;">
                    ...
                    <div class="col-10" style="max-height: 550px; overflow: auto">
                        <h6 class="mb-3">CR Comments</h6>
                        <p> Please use correct type when updating a comment -[ Genaral <?php if ($comtypes) {
                                                                                            foreach ($comtypes as $cr) :

                                                                                                echo ', <span style="color:' . $cr['COLOUR'] . '">' . $cr['COM_TYPE'] . '</span>';
                                                                                            endforeach;
                                                                                        } ?> ] </p>
                        <div class="col-5">
                            <select id='comtypelist' class="form-select">
                                <option value=''>All Comments</option>
                                <option value='Genaral'>Genaral</option>
                                <?php
                                if ($comtypes) {
                                    foreach ($comtypes as $cr) : ?>
                                        <option value='<?php echo $cr['COM_TYPE'] ?>'><?php echo $cr['COM_TYPE'] ?></option>
                                <?php endforeach;
                                } ?>
                                <option value='add'>Add Comment Type</option>
                            </select>
                        </div>
                        <br />
                    ...
                    <div class="col-2" style="max-height: 550px; overflow: auto">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4"><b>Done</b></div>
                            <hr />
                            <?php if ($comtypes) {
                                foreach ($comtypes as $com) : ?>
                                    <?php echo  '<div class="col-8" >' . $com['COM_TYPE'] . '</div><div class="col-4" ><input class="form-check-input" type="checkbox" value="" id="com_' . $com['COM_TYPE'] . '"';
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#selUser').on('change', function() {
                ...
                document.location = "http://ossportal/osscr/?a=project&id=" + crid;
            });
            ...
            $('#taskaddbutton').click(function() {
                var taskdiscription = $("#newtaskname").val();
                var crid = $('#selUser').val();
            ...
            $('#comtypeaddbutton').click(function() {
                ...
                $.post("controller/comtypeController.php?action=add", {
                    ...
                    console.log('return data ' + data);
                    //if (data) {
                    document.location = "http://ossportal/osscr/?a=project&id=" + crid1;
            ...
            $('input[type="checkbox"]').click(function() {
                ...
                if (this.id.match("^com_")) {
                    ...
                    var comtype1 = temp[1];
                    var crid1 = $('#selUser').val();
                    $.post("controller/comtypeController.php?action=update", {
                        comtype: comtype1,
                        id: crid1,
                        status: sentval,
                    }, function(data, status) {
